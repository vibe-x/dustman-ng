...
--translated by k0ta0uchi (http://www.esoui.com/forums/member.php?u=25811)
...
SafeAddString(DUSTMAN_BOOSTERS, "鍛冶ブースターをマーク", 1)
SafeAddString(DUSTMAN_BOOSTERS_DESC, "鍛冶ブースターをガラクタとしてマークするのを有効/無効化します。", 1)
...
SafeAddString(DUSTMAN_NCENCHANT, "クラフト不可能な付呪を持つアイテムを除外", 1)
SafeAddString(DUSTMAN_NCENCHANT_DESC, "有効化されている場合、クラフト不可能な付呪を持つ武器や防具をガラクタとしてマークすることはありません。(例: Masters Weapons).", 1)
...
SafeAddString(DUSTMAN_INGR_OLD, "古い材料をマーク", 1)
SafeAddString(DUSTMAN_INGR_OLD_DESC, "調理に使用できない古い材料をガラクタとしてマークするかを有効/無効化します。", 1)
...
SafeAddString(DUSTMAN_FOOD_BAD, "気持ち悪い食料と飲料をマーク", 1)
SafeAddString(DUSTMAN_FOOD_BAD_DESC, "冷えた/固まった/かび臭い食料と、濁った/気の抜けた/濃い飲料をガラクタとしてマークするかを有効/無効化します。", 1)
...
SafeAddString(DUSTMAN_IMPORT_DESC, "どのキャラクターからDustmanの設定をインポートするかを選択します。設定はキャラクターベースとして残り、キャラクター間で同期されることはありません。", 1)
...
SafeAddString(DUSTMAN_NOTE_RESEACH, "研究可能な特性を持つアイテム: <<t:1>> (<<2>>).", 1)
...
SafeAddString(DUSTMAN_ZOS_RESTRICTIONS, "ZOS制限により、Dustmanは98取引しか処理できませんでした。10秒待ち、再度NPCにインタラクトしてください。", 1)
